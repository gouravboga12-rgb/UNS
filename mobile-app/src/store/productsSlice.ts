...
const mockProducts: Product[] = [
  ...
  },
  {
    ...
    fullDescription: "UNS Detergent Soap is a traditional heavy-duty cleaning bar designed for hand wash laundry. Specially formulated with optical brighteners and blue-cleaning enzymes, it is perfect for target scrubbing collar stains, cuff dirt, grease marks, and grass spots on school uniforms and workwear.",
    images: [
